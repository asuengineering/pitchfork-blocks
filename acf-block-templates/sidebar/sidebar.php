...
// Output mobile select box.
?>
<div class="sidebar-toggler" data-bs-toggle="collapse" data-bs-target="#sidebar-<?php echo esc_html( $menu ); ?>" aria-expanded="false" aria-controls="sidebar-<?php echo esc_html( $menu ); ?>">
...
// Run the nav walker and display the menu.
